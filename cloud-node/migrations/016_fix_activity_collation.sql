-- Migration 016 — fix collation mismatch (1267) on activity views.
-- Prod accounts may use utf8mb4_general_ci while telemetry_events uses utf8mb4_unicode_ci.

ALTER TABLE accounts CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE telemetry_events CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
