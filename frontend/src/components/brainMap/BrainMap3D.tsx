    ...
    >
      ...
      {!loading && !isEmpty && (
        <>
          ...
          <div
            className="pointer-events-auto absolute right-3 top-3 z-10 flex max-w-[calc(100%-1.5rem)] flex-wrap items-center justify-end gap-1.5"
            role="toolbar"
